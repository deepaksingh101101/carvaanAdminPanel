// AdminReducers.js
const { SET_ADMIN_DATA, PUSH_ADMIN, POP_ADMIN, UPDATE_ADMIN, SET_CUSTOMER_DATA, PUSH_CUSTOMER, POP_CUSTOMER, UPDATE_CUSTOMER, SET_ORDER_DATA, PUSH_ORDER, POP_ORDER, UPDATE_ORDER, SET_TRIP_DATA, PUSH_TRIP, POP_TRIP, UPDATE_TRIP, SET_COUPONS_DATA, PUSH_COUPONS, POP_COUPONS, UPDATE_COUPONS, SET_CARVAAN_DATA, PUSH_CARVAAN, POP_CARVAAN, UPDATE_CARVAAN, SET_MANAGE_DATA, PUSH_MANAGE, POP_MANAGE, UPDATE_MANAGE, ADD_BLOG_POST, SET_FAQ_DATA, PUSH_FAQ, POP_FAQ, UPDATE_FAQ, STORE_MEALS, STORE_AGE, STORE_AGENTS, STORE_THEME, STORE_TRANSPORTATION, STORE_ACCOMODATION } = require('./actionTypes');
...
export const AccoReducers = (state ={
  accoData: [], 
}, action) => {
  switch (action.type){
    case STORE_ACCOMODATION:
      return { ...state, accoData: action.payload};
    default:
      return state;
  }
};