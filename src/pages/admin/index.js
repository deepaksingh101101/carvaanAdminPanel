...
const Dashboard = props => {
  ...
  document.title = "Dashboard | Carvaan - React Admin & Dashboard ";
  return (
    <React.Fragment>
            ...
            <Row className="align-items-center">
              <Col md={8}>
                ...
                <ol className="breadcrumb m-0">
                  <li className="breadcrumb-item active">Welcome to Carvaan Dashboard</li>
                </ol>
              </Col>
              ...
              <Col md="4">
                <div className="float-end d-none d-md-block">
                  <Dropdown isOpen={menu} toggle={toggle}>
                    ...
                    <DropdownMenu end>
                      <DropdownItem tag="a" href="#">Change Password</DropdownItem>
                      <DropdownItem tag="a" href="#">Delete Account</DropdownItem>
                    </DropdownMenu>
                  </Dropdown>
                </div>
              </Col>
