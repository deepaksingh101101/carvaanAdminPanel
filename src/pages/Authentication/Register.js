...
const Register = props => {
  ...
  document.title = "Register | Carvaan -";
  return (
    <React.Fragment>
                    ...
                    <Form className="mt-4" onSubmit={(e) => {
                      ...
                      <div className="col-sm-6">
                          <div className="form-check">
                            <input type="checkbox" className="form-check-input" id="isSuperAdmin" />
                            <label className="form-check-label" htmlFor="isSuperAdmin">Is SuperAdmin </label>
                          </div>
                        </div>
